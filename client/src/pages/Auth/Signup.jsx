// Signup page — with real Firebase Auth + role selection
        ...
        <div className="auth-page">
            <div className="auth-card auth-card-wide">
                <div className="auth-header">
                    ...
                    <p>Join CampusCrib and find your perfect room</p>
                </div>
                ...
                <button className="btn-google" onClick={handleGoogleSignup} disabled={loading}>
                    ...
                    Continue with Google as {role === "student" ? "Student" : "Room Owner"}
                </button>
